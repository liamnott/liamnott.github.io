...
function setOtherButtons(tut) {
  ...
  for (let i = 1; i < numButtons; i++) {
    buttons[i].addEventListener("click", checkOverlap);
    buttons[i].click();
  }
...
function checkOverlap() {
  for (let i = 1; i < numButtons; i++) {
    con.addEventListener("mousemove", function() {
      ...
      let yMouse = getMousePos.y;
      let rectangle = buttons[i].getBoundingClientRect();
      let rectX1 = rectangle.left;
      let rectY1 = rectangle.top;
      let rectX2 = rectangle.right;
      let rectY2 = rectangle.bottom;
      console.log("rect", rectX1, rectX2, rectY1, rectY2, xMouse, yMouse);
    ...
    if (checkBoundary(rectX1, rectY1, rectX2, rectY2, xMouse, yMouse)) {
      ...
      buttons[i].style.background = "green";
      console.log("here we are");
      buttons[i].removeEventListener("click", checkOverlap);
    }
  }
}
